...
class AnomalyDetectionEngine(ABC):
    ...
    def detect(
        ...
        Example:
            ...
            ...     print(f"Node {result.node_id}: {result.anomaly_label} "
    ...
    def explain(
        ...
        Example:
            >>> result = engine.detect(series)[0]
            >>> explanation = engine.explain(series, result)
            >>> print(explanation)
            # "Memory usage trend: increasing 2%/minute for last 5 minutes"
        """
        pass
...
class EngineRegistry:
    ...
    Example:
        ...
        >>> registry.register("merlion", MerlionEngine)
        >>> engine = registry.get("merlion", config={...})
    """
